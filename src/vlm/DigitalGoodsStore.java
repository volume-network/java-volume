...
public final class DigitalGoodsStore {
    ...
    public static class Goods {
        ...
        protected Goods(long id, DbKey dbKey, long sellerId, String name, String description, String tags, int timestamp,
        ...
        public Goods(DbKey dbKey, Transaction transaction, Attachment.DigitalGoodsListing attachment) {
            this.dbKey = dbKey;
        ...
        private static DbKey.LongKeyFactory<Goods> goodsDbKeyFactory() {
            return Volume.getStores().getDigitalGoodsStoreStore().getGoodsDbKeyFactory();
        }

        private static VersionedEntityTable<Goods> goodsTable() {
            return Volume.getStores().getDigitalGoodsStoreStore().getGoodsTable();
        }
    ...
    public static class Purchase {
        ...
        protected Purchase(long id, DbKey dbKey, long buyerId, long goodsId, long sellerId, int quantity,
        ...
        private static DbKey.LongKeyFactory<Purchase> purchaseDbKeyFactory() {
            return Volume.getStores().getDigitalGoodsStoreStore().getPurchaseDbKeyFactory();
        }

        private static DbKey.LongKeyFactory<Purchase> feedbackDbKeyFactory() {
            return Volume.getStores().getDigitalGoodsStoreStore().getFeedbackDbKeyFactory();
        }

        private static VersionedValuesTable<Purchase, EncryptedData> feedbackTable() {
            return Volume.getStores().getDigitalGoodsStoreStore().getFeedbackTable();
        }

        private static DbKey.LongKeyFactory<Purchase> publicFeedbackDbKeyFactory() {
            return Volume.getStores().getDigitalGoodsStoreStore().getPublicFeedbackDbKeyFactory();
        }

        private static VersionedValuesTable<Purchase, String> publicFeedbackTable() {
            return Volume.getStores().getDigitalGoodsStoreStore().getPublicFeedbackTable();
        }
