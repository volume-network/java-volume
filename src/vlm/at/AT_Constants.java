...
public class AT_Constants {
    ...
    private AT_Constants() {
        ...
        STEP_FEE.put((short) 1, Constants.ONE_COIN / 10L);
        MAX_STEPS.put((short) 1, 2000L);
        API_STEP_MULTIPLIER.put((short) 1, 10L);

        COST_PER_PAGE.put((short) 1, Constants.ONE_COIN);
        ...
        MAX_PAYLOAD_FOR_BLOCK.put((short) 1, (Volume.getFluxCapacitor().getInt(FluxInt.MAX_PAYLOAD_LENGTH)) / 2L); //use at max half size of the block.
