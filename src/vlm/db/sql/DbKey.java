...
public interface DbKey extends vlm.db.DbKey {

    ArrayList<Condition> getPKConditions(Table tableClass);

    long[] getPKValues();

    abstract class Factory<T> implements vlm.db.DbKey.Factory<T> {
        ...
        public abstract vlm.db.DbKey newKey(T t);

        public abstract vlm.db.DbKey newKey(ResultSet rs);
    ...
    abstract class LongKeyFactory<T> extends Factory<T> implements vlm.db.DbKey.LongKeyFactory<T> {
        ...
        @Override
        public vlm.db.DbKey newKey(ResultSet rs) {
            try {
        ...
        public vlm.db.DbKey newKey(long id) {
    ...
    abstract class LinkKeyFactory<T> extends Factory<T> implements vlm.db.DbKey.LinkKeyFactory<T> {
        ...
        public vlm.db.DbKey newKey(long idA, long idB) {
