...
public class Props {
    ...
    public static final Prop<String> TEST_MAX_HEIGHT = new Prop<>("TEST.MaxHeight", "0");
    public static final Prop<Boolean> DEV_CHECK_BALANCE = new Prop<>("DEV.CheckBalance", false);

    // pool option
    public static final Prop<String> MINE_POOL_PASSPHASE = new Prop<>("vlm.MinePool.passphase", "");
    public static final Prop<String> MINE_POOL_PUBLIC_KEY_LIST = new Prop<>("vlm.MinePool.PublicList", "2999ad94f5270c652b4dbf627882889d9b8df85a3c24eab15ddbe736a84a8f4f;0cf6322b7f77ce7f57465e2287b94c3a5c832496c04e4bbca8c6b947b762cf6c;b55a640fb2f4045c64054f255eb54d4b20b4c7ced72b83c9508e07ac9708854b");
    ...
    public static final Prop<String> BRS_DEBUG_TRACE_QUOTE = new Prop<>("vlm.debugTraceQuote", "\"");
    public static final Prop<String> BRS_DEBUG_TRACE_SEPARATOR = new Prop<>("vlm.debugTraceSeparator", "\t");
    public static final Prop<Boolean> BRS_DEBUG_LOG_CONFIRMED = new Prop<>("vlm.debugLogUnconfirmed", false);
    public static final Prop<String> BRS_DEBUG_TRACE_ACCOUNTS = new Prop<>("vlm.debugTraceAccounts", "");

    public static final Prop<String> BRS_DEBUG_TRACE_LOG = new Prop<>("vlm.debugTraceLog", "LOG_AccountBalances_trace.csv");
    public static final Prop<Integer> BRS_COMMUNICATION_LOGGING_MASK = new Prop<>("vlm.communicationLoggingMask", 0);

    public static final Prop<Integer> BRS_SHUTDOWN_TIMEOUT = new Prop<>("vlm.ShutdownTimeout", 180);

    public static final Prop<String> BRS_FORGING_STRATEGY = new Prop<>("vlm.ForgingStrategy", "slots");
    ...
    // DB options
    public static final Prop<String> DB_URL = new Prop<>("DB.Url", "jdbc:mariadb://localhost:3306/volumewallet");
    ...
    public static final Prop<Boolean> BRS_TEST_UNCONFIRMED_TRANSACTIONS = new Prop<>("vlm.testUnconfirmedTransactions", false);

    public static final Prop<Boolean> DB_H2_DEFRAG_ON_SHUTDOWN = new Prop<>("Db.H2.DefragOnShutdown", false);


    public static final Prop<Integer> BRS_BLOCK_CACHE_MB = new Prop<>("vlm.blockCacheMB", 40);
    ...
    public static final Prop<String> API_ALLOW_ORIGINS = new Prop<>("API.AllowedOrigins", "*");
