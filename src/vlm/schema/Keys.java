...
import vlm.schema.tables.records.*;
...
public class Keys {
    ...
    public static final Identity<GlobalParameterRecord, Integer> IDENTITY_GLOBAL_PARAMETER = Identities0.IDENTITY_GLOBAL_PARAMETER;
    public static final Identity<GoodsRecord, Long> IDENTITY_GOODS = Identities0.IDENTITY_GOODS;
    public static final Identity<PledgesRecord, Long> IDENTITY_PLEDGES = Identities0.IDENTITY_PLEDGES;
    public static final Identity<PoolMinerRecord, Integer> IDENTITY_POOL_MINER = Identities0.IDENTITY_POOL_MINER;
    ...
    public static final UniqueKey<GlobalParameterRecord> KEY_GLOBAL_PARAMETER_PRIMARY = UniqueKeys0.KEY_GLOBAL_PARAMETER_PRIMARY;
    public static final UniqueKey<GlobalParameterRecord> KEY_GLOBAL_PARAMETER_UNIQ_ID_HEIGHT = UniqueKeys0.KEY_GLOBAL_PARAMETER_UNIQ_ID_HEIGHT;
    ...
    public static final UniqueKey<PledgesRecord> KEY_PLEDGES_PRIMARY = UniqueKeys0.KEY_PLEDGES_PRIMARY;
    public static final UniqueKey<PledgesRecord> KEY_PLEDGES_UNIQUE_ID_HEIGHT = UniqueKeys0.KEY_PLEDGES_UNIQUE_ID_HEIGHT;
    public static final UniqueKey<PoolMinerRecord> KEY_POOL_MINER_PRIMARY = UniqueKeys0.KEY_POOL_MINER_PRIMARY;
    ...
    private static class Identities0 {
        ...
        public static Identity<GlobalParameterRecord, Integer> IDENTITY_GLOBAL_PARAMETER = Internal.createIdentity(GlobalParameter.GLOBAL_PARAMETER, GlobalParameter.GLOBAL_PARAMETER.DB_ID);
        public static Identity<GoodsRecord, Long> IDENTITY_GOODS = Internal.createIdentity(Goods.GOODS, Goods.GOODS.DB_ID);
        public static Identity<PledgesRecord, Long> IDENTITY_PLEDGES = Internal.createIdentity(Pledges.PLEDGES, Pledges.PLEDGES.DB_ID);
        public static Identity<PoolMinerRecord, Integer> IDENTITY_POOL_MINER = Internal.createIdentity(PoolMiner.POOL_MINER, PoolMiner.POOL_MINER.DB_ID);
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<GlobalParameterRecord> KEY_GLOBAL_PARAMETER_PRIMARY = Internal.createUniqueKey(GlobalParameter.GLOBAL_PARAMETER, "KEY_global_parameter_PRIMARY", GlobalParameter.GLOBAL_PARAMETER.DB_ID);
        public static final UniqueKey<GlobalParameterRecord> KEY_GLOBAL_PARAMETER_UNIQ_ID_HEIGHT = Internal.createUniqueKey(GlobalParameter.GLOBAL_PARAMETER, "KEY_global_parameter_uniq_id_height", GlobalParameter.GLOBAL_PARAMETER.ID, GlobalParameter.GLOBAL_PARAMETER.HEIGHT);
        ...
        public static final UniqueKey<PledgesRecord> KEY_PLEDGES_PRIMARY = Internal.createUniqueKey(Pledges.PLEDGES, "KEY_pledges_PRIMARY", Pledges.PLEDGES.DB_ID);
        public static final UniqueKey<PledgesRecord> KEY_PLEDGES_UNIQUE_ID_HEIGHT = Internal.createUniqueKey(Pledges.PLEDGES, "KEY_pledges_unique_id_height", Pledges.PLEDGES.ID, Pledges.PLEDGES.HEIGHT);
        public static final UniqueKey<PoolMinerRecord> KEY_POOL_MINER_PRIMARY = Internal.createUniqueKey(PoolMiner.POOL_MINER, "KEY_pool_miner_PRIMARY", PoolMiner.POOL_MINER.DB_ID);
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<BlockRecord, BlockRecord> CONSTRAINT_3C = Internal.createForeignKey(vlm.schema.Keys.KEY_BLOCK_BLOCK_ID_IDX, Block.BLOCK, "constraint_3c", Block.BLOCK.PREVIOUS_BLOCK_ID);
        public static final ForeignKey<BlockRecord, BlockRecord> CONSTRAINT_3C5 = Internal.createForeignKey(vlm.schema.Keys.KEY_BLOCK_BLOCK_ID_IDX, Block.BLOCK, "constraint_3c5", Block.BLOCK.NEXT_BLOCK_ID);
        public static final ForeignKey<TransactionRecord, BlockRecord> CONSTRAINT_FF = Internal.createForeignKey(vlm.schema.Keys.KEY_BLOCK_BLOCK_ID_IDX, Transaction.TRANSACTION, "constraint_ff", Transaction.TRANSACTION.BLOCK_ID);
    }
}
