...
public class Block extends TableImpl<BlockRecord> {
    ...
    private static final long serialVersionUID = -1537886072;
    /**
    ...
    /**
     * The column <code>DB.block.pool_id</code>.
     */
    public final TableField<BlockRecord, Long> POOL_ID = createField("pool_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    /**
     * The column <code>DB.block.forge_reward</code>.
     */
    public final TableField<BlockRecord, Long> FORGE_REWARD = createField("forge_reward", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    /**
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BLOCK_BLOCK_GENERATOR_ID_IDX, Indexes.BLOCK_BLOCK_HEIGHT_IDX, Indexes.BLOCK_BLOCK_ID_IDX, Indexes.BLOCK_BLOCK_POOL_ID_IDX, Indexes.BLOCK_BLOCK_TIMESTAMP_IDX, Indexes.BLOCK_CONSTRAINT_3C, Indexes.BLOCK_CONSTRAINT_3C5, Indexes.BLOCK_PRIMARY);
    }
