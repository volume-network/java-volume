...
public class Account extends TableImpl<AccountRecord> {
    ...
    private static final long serialVersionUID = -1016143469;
    /**
    ...
    /**
     * The column <code>DB.account.pledge_reward_balance</code>.
     */
    public final TableField<AccountRecord, Long> PLEDGE_REWARD_BALANCE = createField("pledge_reward_balance", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
    /**
    ...
    /**
     * The column <code>DB.account.total_pledged</code>.
     */
    public final TableField<AccountRecord, Long> TOTAL_PLEDGED = createField("total_pledged", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
    /**
     * The column <code>DB.account.account_role</code>.
     */
    public final TableField<AccountRecord, Integer> ACCOUNT_ROLE = createField("account_role", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
    /**
