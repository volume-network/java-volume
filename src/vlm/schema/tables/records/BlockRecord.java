...
import vlm.schema.tables.Block;
...
public class BlockRecord extends UpdatableRecordImpl<BlockRecord> implements Record22<Long, Long, Integer, Integer, Long, Long, Long, Integer, byte[], byte[], byte[], Long, Long, Integer, byte[], byte[], byte[], Long, Long, Long, Long, byte[]> {

    private static final long serialVersionUID = 841474958;
    ...
    /**
     * Getter for <code>DB.block.pool_id</code>.
     */
    ...
    /**
     * Setter for <code>DB.block.pool_id</code>.
     */
    ...
    /**
     * Getter for <code>DB.block.forge_reward</code>.
     */
    ...
    /**
     * Setter for <code>DB.block.forge_reward</code>.
     */
    public void setForgeReward(Long value) {
        set(20, value);
    }
     ...
     */
    @Override
    public Row22<Long, Long, Integer, Integer, Long, Long, Long, Integer, byte[], byte[], byte[], Long, Long, Integer, byte[], byte[], byte[], Long, Long, Long, Long, byte[]> fieldsRow() {
     ...
     */
    @Override
    public Row22<Long, Long, Integer, Integer, Long, Long, Long, Integer, byte[], byte[], byte[], Long, Long, Integer, byte[], byte[], byte[], Long, Long, Long, Long, byte[]> valuesRow() {
    ...
    public Field<Long> field21() {
        return Block.BLOCK.FORGE_REWARD;
    }
     ...
     */
    @Override
    public BlockRecord value20(Long value) {
        setPoolId(value);
        return this;
    }
     ...
     */
    @Override
    public BlockRecord value22(byte... value) {
        setAts(value);
        return this;
    }
     ...
     */
    @Override
    public BlockRecord values(Long value1, Long value2, Integer value3, Integer value4, Long value5, Long value6, Long value7, Integer value8, byte[] value9, byte[] value10, byte[] value11, Long value12, Long value13, Integer value14, byte[] value15, byte[] value16, byte[] value17, Long value18, Long value19, Long value20, Long value21, byte[] value22) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
