...
import vlm.feesuggestions.FeeSuggestionType;
...
public class DeeplinkQRCodeGenerator {
    ...
    private static final String OVERLAY_LOCATION = "resources/images/vol_overlay_logo.png";
    ...
    public BufferedImage generateRequestDeepLinkQRCode(String receiverId, long amountNQT, FeeSuggestionType feeSuggestionType, Long feeNQT, String message, boolean immutable)
            throws WriterException {
        final StringBuilder deeplinkBuilder = new StringBuilder("volume://requestVolume");
        ...
        return generateQRCode(deeplinkBuilder.toString());
    }
