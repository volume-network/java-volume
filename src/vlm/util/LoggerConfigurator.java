...
/**
 * Handle logging for the Volume node server
 */
...
public final class LoggerConfigurator {
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "vlm.util.BurstLogManager");
        if (!(LogManager.getLogManager() instanceof ChainLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (!Boolean.getBoolean("vlm.doNotConfigureLogging")) {
            try {
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof ChainLogManager) {
            ((ChainLogManager) LogManager.getLogManager()).chainShutdown();
        }
    }
