...
abstract class CreateTransaction extends APIServlet.APIRequestHandler {
    ...
    final JsonElement createTransaction(HttpServletRequest req, Account senderAccount, Long recipientId, long amountNQT, Attachment attachment) throws VolumeException {
    ...
    private long minimumFeeNQT() {
        return Volume.getFluxCapacitor().isActive(PRE_DYMAXION) ? Constants.FEE_QUANT : Constants.ONE_COIN;
    }
