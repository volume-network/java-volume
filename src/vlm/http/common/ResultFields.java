...
public class ResultFields {
    ...
    public static final String PLEDEG_AMOUNT_RESPONSE = "pledgeAmount";
    public static final String PLEDEG_TIME_RESPONSE = "pledgeTime";
    public static final String UNPLEDEG_AMOUNT_RESPONSE = "unPledgeAmount";
    public static final String WITHDRAW_AMOUNT_RESPONSE = "withdrawAmount";
    public static final String WITHDRAW_TIME_RESPONSE = "withdrawTime";
    ...
    public static final String MINE_POOL_RESPONSE = "minePool";
    public static final String BLOCK_BONUS_RESPONSE = "blockBonus";
    ...
    public static final String ERR_CODE_RESPONSE = "errCode";
    public static final String MSG_RESPONSE = "msg";
    public static final String TOTAL_RESPONSE = "total";
    public static final String TOTAL_PLEDGE_RESPONSE = "totalPledged";
    public static final String TOTAL_UNPLEDGE_RESPONSE = "totalUnpledged";
    public static final String TOTAL_BALANCE_RESPONSE = "totalBalance";
    public static final String TOTAL_TRANSACTION_RESPONSE = "totalTnx";
    public static final String TOTAL_TRANSACTION_IN_RESPONSE = "tnxIn";
    public static final String TOTAL_TRANSACTION_OUT_RESPONSE = "tnxOut";
    public static final String TOTAL_BLOCK_RESPONSE = "blockNum";
    public static final String TOTAL_CAP_RESPONSE = "totalCap";
    public static final String TOTAL_MINER_REWARD_RESPONSE = "mineReward";
    public static final String TOTAL_ADDRESS_COUNT_RESPONSE = "totalAccount";
    public static final String TOTAL_PLEDGE_RATE_RESPONSE = "pledgeRate";
    public static final String LATEAT_BLOCK_REWARD_RESPONSE = "latestBlockReward";
    public static final String TOTAL_FORGED_BALANCE_RESPONSE = "totalForgedBalance";
    public static final String TOTAL_PLEDGE_BALANCE_RESPONSE = "pledgeRewardBalance";
    public static final String MINER_COUNT_RESPONSE = "minerCount";
    public static final String IS_POOL_RESPONSE = "isPool";
    public static final String POOL_RESPONSE = "poolAccount";
    public static final String CUMULATIVE_DIFFIULTY_RESPONSE = "cumulativeDifficulty";
    public static final String ACCOUNT_ROLE_RESPONSE = "accountRole";
    public static final String PLEDGE_REWARD_BALANCE_NQT_RESPONSE = "pledgeRewardBalanceNQT";
    public static final String IS_CURRENT_POOL_RESPONSE = "isCurrentPool";

    public static final String GLOBAL_PLEDGE_RANGE_MIN_RESPONSE = "pledgeRangeMin";
    public static final String GLOBAL_PLEDGE_RANGE_MAX_RESPONSE = "pledgeRangeMax";
    public static final String GLOBAL_MAX_PLEDGE_REWARD_RESPONSE = "maxPledgeReward";
    public static final String GLOBAL_POOL_MAX_CAPICITY_RESPONSE = "poolMaxCapicity";
    public static final String GLOBAL_GEN_BLOCK_RATIO_RESPONSE = "genBlockRatio";
    public static final String GLOBAL_POOL_REWARD_PERCENT_RESPONSE = "poolRewardPercent";
    public static final String GLOBAL_MINER_REWARD_PERCENT_RESPONSE = "minerRewardPercent";
    public static final String GLOBAL_POOLER_ADDRESS_LIST_RESPONSE = "poolerAddressList";
    public static final String GLOBAL_IS_POOL_RESPONSE = "isPool";
    public static final String GLOBAL_POOL_COUNT_RESPONSE = "poolCount";
}
