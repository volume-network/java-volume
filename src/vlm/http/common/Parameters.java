...
public class Parameters {
    ...
    public static final String DUR_PARAMETER = "dur";
    ...
    public static final String PAGE_SIZE_PARAMETER = "limit";
    public static final String PAGE_SORT_PARAMETER = "sort";
    ...
    public static final String AMOUNT_CHAIN_PARAMETER = "amountNXT";
    public static final String FEE_CHAIN_PARAMETER = "feeNXT";
    ...
    public static final String COUNT_TYPE_PARAMETER = "countType";
    public static final String POOL_PARAMETER = "pool";

//  
//  public static final String GLOBAL_PLEDGE_RANGE_MIN = "pledgeRangeMin";
//  public static final String GLOBAL_PLEDGE_RANGE_MAX = "pledgeRangeMax";
//  public static final String GLOBAL_MAX_PLEDGE_REWARD = "maxPledgeReward";
//  public static final String GLOBAL_POOL_MAX_CAPICITY = "poolMaxCapicity";
//  public static final String GLOBAL_GEN_BLOCK_RATIO = "genBlockRatio";
//  public static final String GLOBAL_POOL_REWARD_PERCENT = "poolRewardPercent";
//  public static final String GLOBAL_MINER_REWARD_PERCENT = "minerRewardPercent";
//  public static final String GLOBAL_POOLER_ADDRESS_LIST = "poolerAddressList";
