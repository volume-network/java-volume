...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            "<!DOCTYPE html>\n"
                    ...
                    + "            })\n"
                    + "            .fail(function() {\n"
                    + "                alert('API not available, check if Vol Server is running!');\n"
                    + "            });\n"
                    ...
                    + "           <a class=\"navbar-brand\" href=\"/test\">Vol http API</a>"
                    + "       </div>"
                    + "       <div class=\"navbar-collapse collapse\">"
                    + "           <ul class=\"nav navbar-nav navbar-right\">"
                    + "               <li><input type=\"text\" class=\"form-control\" id=\"search\" "
                    + "                    placeholder=\"Search\" style=\"margin-top:8px;\"></li>\n"
                    + "               <li><a href=\"https://volwiki.org/wiki/The_Burst_API\" target=\"_blank\" style=\"margin-left:20px;\">Wiki Docs</a></li>"
    ...
    private static String form(String requestType, boolean singleView, String className, List<String> parameters, boolean requirePost) {
        ...
        buf.append("<form action=\"/volume\" method=\"POST\" onsubmit=\"return submitForm(this);\">");
