...
public final class JSONResponses {
    ...
    public static final JsonElement MISSING_SIGNATURE = missing(SIGNATURE_PARAMETER);
    public static final JsonElement MISSING_PUBLIC_KEY = missing(PUBLIC_KEY_PARAMETER);
    ...
    public static final JsonElement MISSING_POOL = missing(POOL_PARAMETER);
    public static final JsonElement INCORRECT_POOL = incorrect(POOL_PARAMETER);
    ...
    public static final JsonElement NOT_ENOUGH_PLEDGE;
    public static final JsonElement NOT_ENOUGH_UNPLEDGE;
    ...
    static {
        JsonObject response = new JsonObject();
        response.addProperty(ERROR_CODE_RESPONSE, 6);
        response.addProperty(ERROR_DESCRIPTION_RESPONSE, "Not enough pledge funds");
        NOT_ENOUGH_PLEDGE = response;
    }

    static {
        JsonObject response = new JsonObject();
        response.addProperty(ERROR_CODE_RESPONSE, 6);
        response.addProperty(ERROR_DESCRIPTION_RESPONSE, "Not enough unpledge funds");
        NOT_ENOUGH_UNPLEDGE = response;
    }
