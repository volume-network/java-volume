...
public class Trade {
    ...
    protected Trade(int timestamp, long assetId, long blockId, int height,
                    ...
                    long sellerId, long buyerId, DbKey dbKey, long quantityQNT, long priceNQT) {
    ...
    public Trade(DbKey dbKey, long assetId, Block block, Order.Ask askOrder, Order.Bid bidOrder) {
        this.dbKey = dbKey;
